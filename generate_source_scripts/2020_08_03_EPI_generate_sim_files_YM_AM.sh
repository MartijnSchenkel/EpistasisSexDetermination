...
# bash compile_seed_generator.sh
cd /home/p275703/2019_04_SD_epistasis/seed_generator/
/home/p275703/2019_04_SD_epistasis/seed_generator/seed_gen
cd $HOME
cp /home/p275703/2019_04_SD_epistasis/seed_generator/seed.txt $HOME/2019_04_SD_epistasis/${DATE}/${SIM}/
...
SAI    <- runif(1, min = 0, max = 0.05)
SAII   <- runif(1, min = 0, max = 0)
EpsVal <- runif(1, min = 0, max = 0.05)
